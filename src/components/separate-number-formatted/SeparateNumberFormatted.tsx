...
const SeparateNumberFormatted = ({ value, fontSize = '25px', type, className, onChangePriceFormat, decimalSeparator, thousandSeparator, currency, showCurrency }: ISeparateNumberFormattedProps) => {
